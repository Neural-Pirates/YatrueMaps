...
const Login = () => {
  return (
    <SafeAreaView className="bg-dark-bg flex-1">
      ...
      <Text
        className="text-blue text-left text-lg pl-8 pt-6 font-Geo_extralight"
        onPress={() => console.log("forgot password")}
      >
        Forgot Password?
      </Text>

      <Text className="text-white text-left text-lg pl-8 pt-2 font-Geo_extralight">
        New to YaTrue? &nbsp;
        <Text
          className="text-blue"
          onPress={() =>
      ...
      <View className="w-full items-center mt-14">
        <Pressable
          ...
          className="flex-row items-center justify-between bg-green rounded-full px-2 py-2"
        >
          <Text className="text-dark-bg text-left text-2xl font-Geo_medium mx-44 py-1">
            Log In
          </Text>
        </Pressable>
      </View>
